    ...
    public function _select($tag) {
        ...
        if(!empty($options)) {
            ...
            if(!empty($selected)) {
                ...
                $parseStr   .= '<option selected="selected" value="<?php echo $key ?>"><?php echo is_array($val)?$val['.$title.']:$val; ?></option>';
                $parseStr   .= '<?php }else { ?><option value="<?php echo $key ?>"><?php echo is_array($val)?$val['.$title.']:$val; ?></option>';
                $parseStr   .= '<?php } ?>';
            }else {
                $parseStr   .= '<option value="<?php echo $key ?>"><?php echo is_array($val)?$val['.$title.']:$val; ?></option>';
            }
            $parseStr   .= '<?php } ?>';
