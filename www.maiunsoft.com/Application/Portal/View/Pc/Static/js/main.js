! function() {
	...
	$(".swiper-slide").each(function(index) { if(index > 0) { var t = (new Swiper(".swiper-container", { autoplay: 4e3, prevButton: ".swiper-button-prev", nextButton: ".swiper-button-next", loop: !0, speed: 500, pagination: ".swiper-pagination", paginationClickable: !0, autoplayDisableOnInteraction: !1 }), null) } });
