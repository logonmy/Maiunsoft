		...
		<div class="all-content">
			...
			<div class="content" style="display: block;">
				...
				<?php if(is_array($schoolActivityList)): foreach($schoolActivityList as $key=>$scActivity): ?><div class="template-city" data-city="<?php echo ($scActivity["city"]); ?>">
					...
					<a href='mailto:hr@maiunsoft.com' class="more" data-cont="xiaoyuanzhaopin-data_floor1">投递简历&gt;&gt;</a>
				</div>
					</div><?php endforeach; endif; ?>
			...
			<div class="content">
				...
				<?php if(is_array($traineeList)): foreach($traineeList as $key=>$trainee): ?><div class="template-city" data-city="<?php echo ($trainee["work_city"]); ?>">
					...
					<h3>
						...
						<?php switch($trainee["urgency"]): case "2": ?><img onClick="javascript:;"  src="/www.maiunsoft.com/Application/Portal/View/Mobile/Static/img/ji.png" alt="rush"><?php break;?>
			...
			<div class="content">
				...
				<?php if(is_array($graduateList)): foreach($graduateList as $key=>$graduate): ?><div class="template-city" data-city="<?php echo ($graduate["work_city"]); ?>">
					...
					<h3>
						...
						<?php switch($graduate["urgency"]): case "2": ?><img onClick="javascript:;"  src="/www.maiunsoft.com/Application/Portal/View/Mobile/Static/img/ji.png" alt="rush"><?php break;?>
