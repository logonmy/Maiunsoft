        ...
        <div class="bg-color-5">
            <div class="template-wrap">
                <div class="employ-tabswitch-2">
                    <?php if(is_array($jobTypeList)): foreach($jobTypeList as $key=>$type): $selected = $jobType==$key ? 'switch-active' : ''; ?>
                ...
                <div class="drop-down">
                    <?php if(is_array($jobCityList)): foreach($jobCityList as $key=>$city): $hide = $jobCity!=$key ? 'hide' : ''; ?>
                        <div class="default-item <?php echo ($hide); ?>">
                            <?php echo (trim($city)); ?>
                        </div><?php endforeach; endif; ?>
                </div>
                ...
                <div class="template-card card-switch-2 hide">
                    <div class="template-card-article-2">
                        <h3 class="job-title">FrontEnd实习生</h3>
                        <table>
                            <tr>
                                <td class="table-title">
                                    岗位职责：
