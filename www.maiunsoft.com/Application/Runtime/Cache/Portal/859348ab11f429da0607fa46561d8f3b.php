                 ...
                 -->
					...
					<li>
						...
						<div class="menu-mask hide">
							<div class="menu-left">
								<ul>
									<?php if(is_array($aboutGroupList)): foreach($aboutGroupList as $key=>$ab): ?><li onclick="location='<?php echo U('Company/index',array('id'=>$ab['id']),'');?>'"><?php echo ($ab["name"]); ?><img class="hide vertical-center" src="/www.maiunsoft.com/Application/Portal/View/Pc/Static/imgs/right-arrow.png" alt="right-arrow"></li><?php endforeach; endif; ?>
...
<div class="banner-div banner-4">
        ...
        <div class="template-ceil">
            ...
            <div class="template-ceil-img">
                <img src="/www.maiunsoft.com/Application/Portal/View/Pc/Static/imgs/ceil-img-1.png" alt="">
            </div>
            <p>
            ...
            <div class="template-wrap">
                ...
                <div class="template-card switch-tab-2 hide">
                    ...
                    <div class="template-card-article">
                        ...
                        <p>
                            ...
                            指尽量减少对环境的损害（Environmental Impact）。尽管这一原则得到各方人士的认可，但是由于目前人类科学知识的局限性，对于许多具体问题就会产生截然相反的认识，例如核电站，支持人士认为它可以减少温室气体排放，是环保的，反对人士认为核废料有长期放射性污染，同时核电站存在安全隐患是不环保的。
                            社会要素（Social aspect）
                ...
                <div class="template-card switch-tab-2 hide">
                    ...
                    <div class="template-card-article">
                        <b>可持续发展的公司</b>
                        <p>
                            不僅實現代際公正，更要實現代內公正，即當代一部份人的發展不應損害另一部份人的利益。
